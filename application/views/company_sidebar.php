            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="<?php echo site_url(); ?>" class="app-brand-link">
                        ...
                        <span class="app-brand-text-upper demo menu-text fw-bolder ms-2">ITD SERVICES</span>
                    </a>
                ...
                <ul class="menu-inner py-1">
                    ...
                    <?php if (isset($session_data['is_restrict']) && $session_data['is_restrict'] == 1) { ?>
                        ...
                        <li class="menu-item">
                            ...
                            <ul class="menu-sub">
                                <li class="menu-item">
                                    <a href="<?php echo site_url('company/show_list'); ?>" class="menu-link">
                                        <div data-i18n="Without menu">ALL COMPANY</div>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a href="<?php echo site_url('company/add'); ?>" class="menu-link">
                        ...
                        <ul class="navbar-nav flex-row align-items-center ms-auto">
                            ...
                            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="<?php echo site_url('login/admin_login/logout'); ?>">

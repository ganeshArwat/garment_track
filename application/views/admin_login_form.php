            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">ITD SERVICES</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Welcome to ITD! 👋</h4>
              <p class="mb-4">Please Log-in to your account and start the adventure</p>

              <form id="login" class="login100-form validate-form" action="index.html" method="POST">
                <div class="mb-3">
                ...
                <div class="mb-3 form-password-toggle">
                  ...
                  <div class="input-group input input-group-merge">
                    <input
                      type="password"
                      id="password"
                      class="form-control"

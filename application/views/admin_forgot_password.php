<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>css/login_style?123.css">
<div class="container">
    <div class="img">
        <img src="<?php echo base_url(); ?>images/preview_52173.jpg">
    </div>
    <div class="login-content">
        <form class="login100-form validate-form" method="post" id="login" action="<?php echo site_url("login/admin_login/send_password") . "?cron_company=" . $company_id; ?>">

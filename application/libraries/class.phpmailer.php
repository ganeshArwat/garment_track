...
|   Authors: Andy Prevost (codeworxtech) yuvraj@orggen.com |
|          : Marcus Bointon (coolbru) yuvraj@orggen.com         |
|          : Jim Jagielski (jimjag) yuvraj@orggen.com                       |
 ...
 * @version $Id: class.phpmailer.php 5817 2012-08-13 08:49:53Z rushikesh $
...
class PHPMailer
{
  ...
  /**
   * Used with DKIM DNS Resource Record
   * optional, in format of email address 'yuvraj@orggen.com'
   * @var string
   */

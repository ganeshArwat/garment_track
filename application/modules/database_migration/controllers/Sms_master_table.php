<?php
class Sms_master_table extends MX_Controller
{
    public function column_list()
    {
        $column_structure = array(
            ...
            2 => 'Field:identifier_id, Type:int(11), Null:NO, Key:, Default:, Extra:',
            3 => 'Field:sms_text, Type:text, Null:NO, Key:, Default:, Extra:',
            4 => 'Field:template_name, Type:varchar(255), Null:NO, Key:, Default:, Extra:',

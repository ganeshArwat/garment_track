<?php
                        class Company_invoice_range_table extends MX_Controller
                        {
...
3 => 'Field:master_service_type, Type:int(11), Null:NO, Key:, Default:, Extra:',
4 => 'Field:invoice_range_id, Type:int(11), Null:NO, Key:, Default:, Extra:',

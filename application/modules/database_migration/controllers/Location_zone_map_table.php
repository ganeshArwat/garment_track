<?php
class Location_zone_map_table extends MX_Controller
{
    public function column_list()
    {
        $column_structure = array(
            ...
            2 => 'Field:location_id, Type:int(11), Null:NO, Key:, Default:, Extra:',
            3 => 'Field:billing_type, Type:int(11), Null:NO, Key:, Default:, Extra:',
            4 => 'Field:zone_id, Type:int(11), Null:NO, Key:, Default:, Extra:',

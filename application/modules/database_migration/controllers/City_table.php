<?php
class City_table extends MX_Controller
{
    public function column_list()
    {
        $column_structure = array(
            ...
            4 => 'Field:district_id, Type:int(11), Null:NO, Key:, Default:, Extra:',
            ...
            9 => 'Field:is_master_city, Type:tinyint(1), Null:NO, Key:, Default:, Extra:',
        );

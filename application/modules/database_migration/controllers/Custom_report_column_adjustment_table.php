<?php
class Custom_report_column_adjustment_table extends MX_Controller
{
    public function column_list()
    {
        $column_structure = array(
            ...
            2 => 'Field:custom_report_id, Type:int(11), Null:NO, Key:MUL, Default:, Extra:',
            3 => 'Field:name, Type:varchar(255), Null:NO, Key:, Default:, Extra:',
            4 => 'Field:value, Type:varchar(255), Null:NO, Key:, Default:, Extra:',
            5 => 'Field:adjustment_type, Type:tinyint(1), Null:NO, Key:, Default:, Extra:',

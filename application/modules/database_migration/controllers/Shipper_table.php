<?php
                        class Shipper_table extends MX_Controller
                        {
...
9 => 'Field:dob, Type:date, Null:NO, Key:, Default:, Extra:',
...
15 => 'Field:country, Type:int(11), Null:NO, Key:, Default:, Extra:',
16 => 'Field:gstin_no, Type:varchar(255), Null:NO, Key:, Default:, Extra:',
17 => 'Field:proof1, Type:varchar(255), Null:NO, Key:, Default:, Extra:',
18 => 'Field:proof2, Type:varchar(255), Null:NO, Key:, Default:, Extra:',
19 => 'Field:dial_code, Type:varchar(255), Null:NO, Key:, Default:, Extra:',
20 => 'Field:auto_generate_no, Type:int(11), Null:NO, Key:, Default:, Extra:',
21 => 'Field:company_name, Type:varchar(255), Null:NO, Key:, Default:, Extra:',
...
26 => 'Field:migration_id, Type:int(11), Null:NO, Key:, Default:, Extra:',
27 => 'Field:gstin_type_2, Type:int(11), Null:NO, Key:, Default:, Extra:',
28 => 'Field:gstin_no_2, Type:varchar(255), Null:NO, Key:, Default:, Extra:',
);

<?php
                        class Task_table extends MX_Controller
                        {
...
3 => 'Field:description, Type:text, Null:NO, Key:, Default:, Extra:',
4 => 'Field:task_status, Type:tinyint(1), Null:NO, Key:, Default:, Extra:',
5 => 'Field:task_type, Type:tinyint(1), Null:NO, Key:, Default:, Extra:',
6 => 'Field:assigned_date, Type:datetime, Null:NO, Key:, Default:, Extra:',

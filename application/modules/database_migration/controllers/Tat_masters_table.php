<?php
class Tat_masters_table extends MX_Controller
{
    public function column_list()
    {
        $column_structure = array(
            ...
            15 => 'Field:dest_hub_id, Type:int(11), Null:NO, Key:, Default:, Extra:',
            ...
            24 => 'Field:tat_type, Type:tinyint(1), Null:NO, Key:, Default:1, Extra:',

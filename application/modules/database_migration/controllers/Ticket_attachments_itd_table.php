<?php
class Ticket_attachments_itd_table extends MX_Controller
{
    public function column_list()
    {
        $column_structure = array(
            ...
            4 => 'Field:ticket_id, Type:int(11), Null:NO, Key:MUL, Default:, Extra:',
            5 => 'Field:attachment_path, Type:text, Null:NO, Key:, Default:, Extra:',

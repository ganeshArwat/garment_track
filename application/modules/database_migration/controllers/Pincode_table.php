<?php
class Pincode_table extends MX_Controller
{
    public function column_list()
    {
        $column_structure = array(
            ...
            4 => 'Field:country_id, Type:int(11), Null:NO, Key:MUL, Default:, Extra:',
            ...
            9 => 'Field:city_id, Type:int(11), Null:NO, Key:MUL, Default:, Extra:',
            10 => 'Field:state_id, Type:int(11), Null:NO, Key:MUL, Default:, Extra:',
            11 => 'Field:district_id, Type:int(11), Null:NO, Key:MUL, Default:, Extra:',
        );

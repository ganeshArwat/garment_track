<?php
                        class Docket_comment_table extends MX_Controller
                        {
...
3 => 'Field:comment_date, Type:date, Null:NO, Key:, Default:, Extra:',
4 => 'Field:comment_time, Type:time, Null:NO, Key:, Default:, Extra:',
5 => 'Field:description, Type:text, Null:NO, Key:, Default:, Extra:',
6 => 'Field:attachment, Type:varchar(255), Null:NO, Key:, Default:, Extra:',

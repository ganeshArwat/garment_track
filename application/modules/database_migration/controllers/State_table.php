<?php
                        class State_table extends MX_Controller
                        {
...
4 => 'Field:country_id, Type:int(11), Null:NO, Key:, Default:, Extra:',
...
9 => 'Field:is_north_east_and_jk, Type:tinyint(1), Null:NO, Key:, Default:, Extra:',
);

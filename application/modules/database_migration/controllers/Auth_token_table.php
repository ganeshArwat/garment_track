<?php
class Auth_token_table extends MX_Controller
{
    public function column_list()
    {
        $column_structure = array(
            ...
            7 => 'Field:authtoken, Type:varchar(255), Null:NO, Key:, Default:, Extra:',
            8 => 'Field:tokenexpiry, Type:datetime, Null:NO, Key:, Default:, Extra:',
        );

<?php
                        class Custom_report_table extends MX_Controller
                        {
...
3 => 'Field:docket_setting_data, Type:text, Null:NO, Key:, Default:, Extra:',
4 => 'Field:role_id, Type:varchar(255), Null:NO, Key:, Default:, Extra:',
...
9 => 'Field:selected_column_name, Type:text, Null:NO, Key:, Default:, Extra:',
);

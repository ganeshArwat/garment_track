<?php
                        class Description_table extends MX_Controller
                        {
...
4 => 'Field:fetch_grand_total_of_awb, Type:tinyint(1), Null:NO, Key:, Default:2, Extra:',
5 => 'Field:is_claim, Type:tinyint(1), Null:NO, Key:, Default:2, Extra:',

<?php
                        class Ticket_status_itd_history_table extends MX_Controller
                        {
...
4 => 'Field:created_by_trackmate, Type:int(11), Null:NO, Key:, Default:, Extra:',
...
8 => 'Field:ticket_id, Type:int(11), Null:NO, Key:MUL, Default:, Extra:',
);

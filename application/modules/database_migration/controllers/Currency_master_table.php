<?php
                        class Currency_master_table extends MX_Controller
                        {
...
2 => 'Field:code_id, Type:int(11), Null:NO, Key:, Default:, Extra:',
3 => 'Field:symbol, Type:varchar(255), Null:NO, Key:, Default:, Extra:',
4 => 'Field:serial_no, Type:varchar(255), Null:NO, Key:, Default:, Extra:',

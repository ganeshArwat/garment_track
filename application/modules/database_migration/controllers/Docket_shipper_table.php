<?php
class Docket_shipper_table extends MX_Controller
{
    public function column_list()
    {
        $column_structure = array(
            ...
            24 => 'Field:auto_generate_no, Type:int(11), Null:NO, Key:, Default:, Extra:',
            25 => 'Field:dial_code, Type:varchar(255), Null:NO, Key:, Default:, Extra:',
            26 => 'Field:doc_path2, Type:varchar(255), Null:NO, Key:, Default:, Extra:',
            ...
            29 => 'Field:doc_path3, Type:varchar(255), Null:NO, Key:, Default:, Extra:',
            30 => 'Field:doc_path4, Type:varchar(255), Null:NO, Key:, Default:, Extra:',
        );

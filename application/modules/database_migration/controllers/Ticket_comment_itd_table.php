<?php
class Ticket_comment_itd_table extends MX_Controller
{
    public function column_list()
    {
        $column_structure = array(
            ...
            2 => 'Field:ticket_id, Type:int(11), Null:NO, Key:MUL, Default:, Extra:',
            ...
            6 => 'Field:created_by_trackmate, Type:int(11), Null:NO, Key:, Default:, Extra:',

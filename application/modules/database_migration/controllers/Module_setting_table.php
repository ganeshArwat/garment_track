<?php
                        class Module_setting_table extends MX_Controller
                        {
...
4 => 'Field:config_key, Type:varchar(255), Null:NO, Key:, Default:, Extra:',
5 => 'Field:config_value, Type:varchar(255), Null:NO, Key:, Default:, Extra:',

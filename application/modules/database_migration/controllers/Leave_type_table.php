<?php
                        class Leave_type_table extends MX_Controller
                        {
...
3 => 'Field:no_of_day, Type:int(11), Null:NO, Key:, Default:, Extra:',
4 => 'Field:is_restrict, Type:tinyint(2), Null:NO, Key:, Default:2, Extra:',

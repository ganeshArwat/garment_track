<?php
                        class Docket_status_table extends MX_Controller
                        {
...
4 => 'Field:add_in_invoice, Type:tinyint(1), Null:NO, Key:, Default:, Extra:',
...
4 => 'Field:dont_calculate_charge, Type:tinyint(1), Null:NO, Key:, Default:, Extra:',
);

<?php
class Service_type_table extends MX_Controller
{
    public function column_list()
    {
        $column_structure = array(
            ...
            4 => 'Field:gst_per, Type:decimal(20,2), Null:NO, Key:, Default:, Extra:',
            ...
            9 => 'Field:sac_code, Type:varchar(255), Null:NO, Key:, Default:, Extra:',
            10 => 'Field:vat_per, Type:decimal(20,2), Null:NO, Key:, Default:, Extra:',
        );

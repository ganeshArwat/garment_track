                ...
                <div class="row">
                    <div class="col-sm-3">
                        ...
                        <div class="form-group">
                            ...
                            <input placeholder="SEARCH HERE..." class="form-control" id="company_search_name" type="text" value="<?php echo isset($get_data['company_id']) && isset($all_company[$get_data['company_id']]) ? $all_company[$get_data['company_id']]['company_name'] : ''; ?>" />
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="form-group" style="padding-top:23px;">
                            ...
                            <a tabindex="6" class="btn btn-info" title="View All Company" href="<?php echo site_url('company/show_list'); ?>"><i class="fa fa-newspaper-o" aria-hidden="true"></i>&nbsp;RESET</a>
                            <a tabindex="7" class="btn btn-danger" title="Add Company" href="<?php echo site_url('company/add'); ?>"><i class="fa fa-plus-square" aria-hidden="true"></i>&nbsp;Add</a>
...
<div class="col-12">
    ...
    <div class="box">
        <div class="box-header with-border">
            <span>Total No. Of Company: <?php echo isset($total) ? $total : 0; ?></span>
                    ...
                    if (isset($list) && is_array($list) && count($list) > 0) {
                        foreach ($list as $key => $value) { ?>
                            <tr class="<?php echo $value['status'] == 2 ? 'inactive_row' : ''; ?>">
                                ...
                                <td>
                                    <a href="<?php echo site_url('company/edit/' . $value['id']) ?>" title="Update Company" class="edit_button">Edit</a>

                                    <a target="blank" href="<?php echo site_url('cron/droplet_api/db_backup/' . $value['id'] . '?cron_company=' . $value['id']) ?>" title="BACKUP Company" class="delete_button backup_company">Backup Database</a>
